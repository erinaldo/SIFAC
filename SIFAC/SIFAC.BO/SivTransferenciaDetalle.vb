...
#Region " Variables Miembro " 
	Protected m_SivTrasnferenciaDetalleID As Integer 
	Protected m_objTransferenciaID As Integer 
	Protected m_objBodegaDestinoID As Integer 
...
#Region " Propiedades "
	Public Property SivTrasnferenciaDetalleID() As Integer
        Get
            Return (m_SivTrasnferenciaDetalleID)
        End Get
		Set(ByVal Value As Integer)					
			m_SivTrasnferenciaDetalleID = Value
		End Set
    End Property
	...
	Public Property objBodegaDestinoID() As Integer
        Get
            Return (m_objBodegaDestinoID)
        End Get
		Set(ByVal Value As Integer)					
			m_objBodegaDestinoID = Value
		End Set
    End Property
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdDelete.Parameters.Add("@SivTrasnferenciaDetalleID", SqlDbType.Int, 4, "SivTrasnferenciaDetalleID" )
			cmdDelete.CommandText = "DELETE FROM  SivTransferenciaDetalle WHERE SivTrasnferenciaDetalleID= @SivTrasnferenciaDetalleID" 	

			'CREACION DEL COMANDO INSERT
            cmdInsert.Parameters.Add("@objTransferenciaID", SqlDbType.Int, 4, "objTransferenciaID")
            cmdInsert.Parameters.Add("@objBodegaDestinoID", SqlDbType.Int, 4, "objBodegaDestinoID")
            ...
            cmdInsert.CommandText = "INSERT INTO SivTransferenciaDetalle ( objTransferenciaID, objBodegaDestinoID, objSivProductoID, CantidadSolicitada, CantidadDespachada, CantidadRecibida, costo, subtotal, ExistenciaAnteriorEntrada, ExistenciaAnteriorSalida, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion) VALUES ( @objTransferenciaID, @objBodegaDestinoID, @objSivProductoID, @CantidadSolicitada, @CantidadDespachada, @CantidadRecibida, @costo, @subtotal, @ExistenciaAnteriorEntrada, @ExistenciaAnteriorSalida, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion)"

            'CREACION DEL COMANDO UPDATE
            cmdUpdate.Parameters.Add("@objTransferenciaID", SqlDbType.Int, 4, "objTransferenciaID")
            cmdUpdate.Parameters.Add("@objBodegaDestinoID", SqlDbType.Int, 4, "objBodegaDestinoID")
            ...
            cmdUpdate.Parameters.Add("@wSivTrasnferenciaDetalleID", SqlDbType.Int, 4, "SivTrasnferenciaDetalleID")
            cmdUpdate.CommandText = "UPDATE SivTransferenciaDetalle SET objTransferenciaID=@objTransferenciaID, objBodegaDestinoID=@objBodegaDestinoID, objSivProductoID=@objSivProductoID, CantidadSolicitada=@CantidadSolicitada, CantidadDespachada=@CantidadDespachada, CantidadRecibida=@CantidadRecibida, costo=@costo, subtotal=@subtotal, ExistenciaAnteriorEntrada=@ExistenciaAnteriorEntrada, ExistenciaAnteriorSalida=@ExistenciaAnteriorSalida, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion WHERE SivTrasnferenciaDetalleID= @wSivTrasnferenciaDetalleID"
...
#Region " Retrieve "
    ...
    Public Function Retrieve(ByVal p_SivTrasnferenciaDetalleID As Integer, Optional ByVal pTransac As TransactionManager = Nothing) As Boolean
        Dim sSQL As String = "select * from SivTransferenciaDetalle where " & " SivTrasnferenciaDetalleID = " & p_SivTrasnferenciaDetalleID
        ...
        Try
            ...
            If dr.Read() Then
                m_SivTrasnferenciaDetalleID = dr("SivTrasnferenciaDetalleID")
                m_objTransferenciaID = IIf(IsDBNull(dr("objTransferenciaID")), Nothing, dr("objTransferenciaID"))
                m_objBodegaDestinoID = IIf(IsDBNull(dr("objBodegaDestinoID")), Nothing, dr("objBodegaDestinoID"))
...
#Region " Insert "
    ...
    Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        sCommand &= " select "
        sCommand &= "@SivTrasnferenciaDetalleID = SivTrasnferenciaDetalleID from SivTransferenciaDetalle where "
        sCommand &= "SivTrasnferenciaDetalleID = SCOPE_IDENTITY()"


        Dim arParams(14) As SqlParameter
        arParams(0) = New SqlParameter("@SivTrasnferenciaDetalleID", SqlDbType.Int)
        arParams(0).Direction = ParameterDirection.Output
        arParams(1) = New SqlParameter("@objTransferenciaID", SqlDbType.Int)
        If IsDBNull(m_objTransferenciaID) Then
            arParams(1).Value = DBNull.Value
        Else
            arParams(1).Value = m_objTransferenciaID
        End If
        arParams(2) = New SqlParameter("@objBodegaDestinoID", SqlDbType.Int)
        If IsDBNull(m_objBodegaDestinoID) Then
            arParams(2).Value = DBNull.Value
        Else
            arParams(2).Value = m_objBodegaDestinoID
        End If
        arParams(3) = New SqlParameter("@objSivProductoID", SqlDbType.Int)
        If IsDBNull(m_objSivProductoID) Then
            arParams(3).Value = DBNull.Value
        Else
            arParams(3).Value = m_objSivProductoID
        End If
        arParams(4) = New SqlParameter("@CantidadSolicitada", SqlDbType.Int)
        If IsDBNull(m_CantidadSolicitada) Then
            arParams(4).Value = DBNull.Value
        Else
            arParams(4).Value = m_CantidadSolicitada
        End If
        arParams(5) = New SqlParameter("@CantidadDespachada", SqlDbType.Int)
        If IsDBNull(m_CantidadDespachada) Then
            arParams(5).Value = DBNull.Value
        Else
            arParams(5).Value = m_CantidadDespachada
        End If
        arParams(6) = New SqlParameter("@CantidadRecibida", SqlDbType.Int)
        If IsDBNull(m_CantidadRecibida) Then
            arParams(6).Value = DBNull.Value
        Else
            arParams(6).Value = m_CantidadRecibida
        End If
        arParams(7) = New SqlParameter("@costo", SqlDbType.Decimal)
        If IsDBNull(m_costo) Then
            arParams(7).Value = DBNull.Value
        Else
            arParams(7).Value = m_costo
        End If
        arParams(8) = New SqlParameter("@subtotal", SqlDbType.Decimal)
        If IsDBNull(m_subtotal) Then
            arParams(8).Value = DBNull.Value
        Else
            arParams(8).Value = m_subtotal
        End If
        arParams(9) = New SqlParameter("@ExistenciaAnteriorEntrada", SqlDbType.Int)
        If IsDBNull(m_ExistenciaAnteriorEntrada) Then
            arParams(9).Value = DBNull.Value
        Else
            arParams(9).Value = m_ExistenciaAnteriorEntrada
        End If
        arParams(10) = New SqlParameter("@ExistenciaAnteriorSalida", SqlDbType.Int)
        If IsDBNull(m_ExistenciaAnteriorSalida) Then
            arParams(10).Value = DBNull.Value
        Else
            arParams(10).Value = m_ExistenciaAnteriorSalida
        End If
        ...
        Try
            ...
            m_SivTrasnferenciaDetalleID = arParams(0).Value
        Catch ex As Exception
            Throw
        End Try
    End Sub
...
#Region " Update "
    ...
    Public Sub Update(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        sCommand &= "objBodegaDestinoID = @objBodegaDestinoID,"
        ...
        sCommand &= " where "
        sCommand &= "SivTrasnferenciaDetalleID = @SivTrasnferenciaDetalleID"

        Dim arParams(14) As SqlParameter
        arParams(0) = New SqlParameter("@SivTrasnferenciaDetalleID", SqlDbType.Int)
        If IsDBNull(m_SivTrasnferenciaDetalleID) Then
            arParams(0).Value = DBNull.Value
        Else
            arParams(0).Value = m_SivTrasnferenciaDetalleID
        End If
        arParams(1) = New SqlParameter("@objTransferenciaID", SqlDbType.Int)
        If IsDBNull(m_objTransferenciaID) Then
            arParams(1).Value = DBNull.Value
...
#Region " Delete "
    ...
    Public Sub Delete(optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SivTransferenciaDetalle where " & " SivTrasnferenciaDetalleID = " & m_SivTrasnferenciaDetalleID
			If pTransac Is Nothing Then
    ...
    ''' Borra un objeto SivTransferenciaDetalle de la base de datos
    ''' </summary>    
    Public Shared Sub Delete(Byval p_SivTrasnferenciaDetalleID as Integer, optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SivTransferenciaDetalle where " & " SivTrasnferenciaDetalleID = " & p_SivTrasnferenciaDetalleID
			If pTransac Is Nothing Then
				SqlHelper.ExecuteNonQuery(CommandType.Text, sSQL)
			Else
				SqlHelper.ExecuteNonQuery(pTransac.Transaction, CommandType.Text, sSQL)
