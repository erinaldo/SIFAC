...
#Region " Variables Miembro " 
	...
	Protected m_objSfaFacturasID As Integer 
...
#Region " Propiedades "
	...
	Public Property objSfaFacturasID() As Integer
        Get
            Return (m_objSfaFacturasID)
        End Get
		Set(ByVal Value As Integer)					
			m_objSfaFacturasID = Value
		End Set
    End Property
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.Parameters.Add("@objSfaFacturasID", SqlDbType.Int, 4, "objSfaFacturasID")
			...
			cmdInsert.CommandText = "INSERT INTO SccDevolucion ( objEstadoID, objSfaFacturasID, objSccCuentaID, Numero, Fecha, TotalDevolucion, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion) VALUES ( @objEstadoID, @objSfaFacturasID, @objSccCuentaID, @Numero, @Fecha, @TotalDevolucion, @UsuarioCreacion, @FechaCreacion, @UsuarioModificacion, @FechaModificacion)"

			'CREACION DEL COMANDO UPDATE
			cmdUpdate.Parameters.Add("@objEstadoID", SqlDbType.Int, 4, "objEstadoID")
			cmdUpdate.Parameters.Add("@objSfaFacturasID", SqlDbType.Int, 4, "objSfaFacturasID")
			...
			cmdUpdate.CommandText = "UPDATE SccDevolucion SET objEstadoID=@objEstadoID, objSfaFacturasID=@objSfaFacturasID, objSccCuentaID=@objSccCuentaID, Numero=@Numero, Fecha=@Fecha, TotalDevolucion=@TotalDevolucion, UsuarioCreacion=@UsuarioCreacion, FechaCreacion=@FechaCreacion, UsuarioModificacion=@UsuarioModificacion, FechaModificacion=@FechaModificacion WHERE SccDevolucionID= @wSccDevolucionID"
    ...
    Public Function Retrieve(Byval p_SccDevolucionID as Integer, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        ...
        Try
			...
			If dr.Read() Then		
				...
				m_objSfaFacturasID = IIf(IsDBNull(dr("objSfaFacturasID")), Nothing, dr("objSfaFacturasID"))					
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(2) = New SqlParameter("@objSfaFacturasID", SqlDbType.Int)		
		If IsDBNull(m_objSfaFacturasID) Then
            arParams(2).Value = DBNull.Value
        Else
            arParams(2).Value = m_objSfaFacturasID
        End If
        ...
        End If
		arParams(4) = New SqlParameter("@Numero", SqlDbType.Int)		
        ...
        End If
		arParams(6) = New SqlParameter("@TotalDevolucion", SqlDbType.Decimal)		
		If IsDBNull(m_TotalDevolucion) Then
            arParams(6).Value = DBNull.Value
        Else
            arParams(6).Value = m_TotalDevolucion
        End If
...
#Region " Update "
	...
	Public Sub Update(Optional ByRef pTransac As TransactionManager = Nothing)        		
		...
		sCommand &= "objSfaFacturasID = @objSfaFacturasID,"
