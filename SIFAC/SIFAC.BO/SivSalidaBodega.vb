...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.CommandText = "INSERT INTO SivSalidaBodega ( objTipoSalidaID, objTipoAjusteID, objEstadoID, objStbBodegaID, FechaSalida, costototal, Comentarios, ComentariosAnular, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion) VALUES ( @objTipoSalidaID, @objTipoAjusteID, @objEstadoID, @objStbBodegaID, @FechaSalida, @costototal, @Comentarios, @ComentariosAnular, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion)"
			...
			cmdUpdate.CommandText = "UPDATE SivSalidaBodega SET objTipoSalidaID=@objTipoSalidaID, objTipoAjusteID=@objTipoAjusteID, objEstadoID=@objEstadoID, objStbBodegaID=@objStbBodegaID, FechaSalida=@FechaSalida, costototal=@costototal, Comentarios=@Comentarios, ComentariosAnular=@ComentariosAnular, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion WHERE SivSalidaBodegaID= @wSivSalidaBodegaID"
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
		...
		arParams(1) = New SqlParameter("@objTipoSalidaID", SqlDbType.Int)		
		If IsDBNull(m_objTipoSalidaID) Then
            arParams(1).Value = DBNull.Value
        Else
            arParams(1).Value = m_objTipoSalidaID
        End If
		arParams(2) = New SqlParameter("@objTipoAjusteID", SqlDbType.Int)		
		If IsDBNull(m_objTipoAjusteID) Then
            arParams(2).Value = DBNull.Value
        Else
            arParams(2).Value = m_objTipoAjusteID
        End If
        ...
        End If
		arParams(4) = New SqlParameter("@objStbBodegaID", SqlDbType.Int)		
		If IsDBNull(m_objStbBodegaID) Then
            arParams(4).Value = DBNull.Value
        Else
            arParams(4).Value = m_objStbBodegaID
        End If
