...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.CommandText = "INSERT INTO SccNotaCredito ( Numero, Fecha, Monto, objConceptoID, Descripcion, objEstadoID, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion, objDevolucionID, objSccCuentaID) VALUES ( @Numero, @Fecha, @Monto, @objConceptoID, @Descripcion, @objEstadoID, @UsuarioCreacion, @FechaCreacion, @UsuarioModificacion, @FechaModificacion, @objDevolucionID, @objSccCuentaID)"
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
		...
		sCommand &= "objSccCuentaID) values ("		
		sCommand &= "@Numero,"
		sCommand &= "@Fecha,"
		sCommand &= "@Monto,"
		sCommand &= "@objConceptoID,"
        ...
        End If
		arParams(12) = New SqlParameter("@objSccCuentaID", SqlDbType.Int)		
