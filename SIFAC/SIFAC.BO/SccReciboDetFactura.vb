...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.CommandText = "INSERT INTO SccReciboDetFactura ( objReciboCajaID, objSfaFacturaID, Monto, EsAbono, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion) VALUES ( @objReciboCajaID, @objSfaFacturaID, @Monto, @EsAbono, @UsuarioCreacion, @FechaCreacion, @UsuarioModificacion, @FechaModificacion)"
			...
			cmdUpdate.CommandText = "UPDATE SccReciboDetFactura SET objReciboCajaID=@objReciboCajaID, objSfaFacturaID=@objSfaFacturaID, Monto=@Monto, EsAbono=@EsAbono, UsuarioCreacion=@UsuarioCreacion, FechaCreacion=@FechaCreacion, UsuarioModificacion=@UsuarioModificacion, FechaModificacion=@FechaModificacion WHERE SccReciboDetFacturaID= @wSccReciboDetFacturaID"
