...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.CommandText = "INSERT INTO SivEntradaBodega ( objTipoEntradaID, objEstadoID, objStbBodegaID, FechaEntrada, CostoTotal, NumeroFactura, FechaFactura, Comentarios, Anulada, ComentarioAnular, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion) VALUES ( @objTipoEntradaID, @objEstadoID, @objStbBodegaID, @FechaEntrada, @CostoTotal, @NumeroFactura, @FechaFactura, @Comentarios, @Anulada, @ComentarioAnular, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion)"
			...
			cmdUpdate.CommandText = "UPDATE SivEntradaBodega SET objTipoEntradaID=@objTipoEntradaID, objEstadoID=@objEstadoID, objStbBodegaID=@objStbBodegaID, FechaEntrada=@FechaEntrada, CostoTotal=@CostoTotal, NumeroFactura=@NumeroFactura, FechaFactura=@FechaFactura, Comentarios=@Comentarios, Anulada=@Anulada, ComentarioAnular=@ComentarioAnular, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion WHERE SivEntradaBodegaID= @wSivEntradaBodegaID"
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(8) = New SqlParameter("@Comentarios", SqlDbType.VarChar)		
		If IsDBNull(m_Comentarios) Then
            arParams(8).Value = DBNull.Value
        Else
            arParams(8).Value = m_Comentarios
        End If
		arParams(9) = New SqlParameter("@Anulada", SqlDbType.Bit)		
		If IsDBNull(m_Anulada) Then
            arParams(9).Value = DBNull.Value
        Else
            arParams(9).Value = m_Anulada
        End If
		arParams(10) = New SqlParameter("@ComentarioAnular", SqlDbType.VarChar)		
		If IsDBNull(m_ComentarioAnular) Then
            arParams(10).Value = DBNull.Value
        Else
            arParams(10).Value = m_ComentarioAnular
        End If
