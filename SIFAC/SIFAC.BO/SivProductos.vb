...
#Region " Variables Miembro " 
	...
	Protected m_Margen_Utilidad_Credito As Nullable(Of Decimal) 
	Protected m_Margen_Utilidad_Contado As Nullable(Of Decimal) 
	Protected m_Cantidad_Minima As Nullable(Of Decimal) 
...
#Region " Propiedades "
		...
		Set(ByVal Value As String)		
			If Not Value Is Nothing Then
				If Value.Length > 50 Then
					Throw New ArgumentOutOfRangeException("Codigo", Value.ToString(), "Valor inv?lido para SivProductos.Codigo. La longitud del valor (" & Value.Length & ") excede la longitud m?xima de la propiedad (50).")
				End If
			End If
			m_Codigo = Value
		End Set
	...
	Public Property Margen_Utilidad_Credito() As Nullable(Of Decimal)
        Get
	...
	Public Property Margen_Utilidad_Contado() As Nullable(Of Decimal)
        Get
	...
	Public Property Cantidad_Minima() As Nullable(Of Decimal)
        Get
	...
	Public Shared Function GetMaxLength(ProperyName as String) as Integer
		Select Case ProperyName
			...
			Case "Precio_Contado"
				Return	11
			Case "Margen_Utilidad_Credito"
				Return	11
			Case "Margen_Utilidad_Contado"
				Return	11
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.Parameters.Add("@Margen_Utilidad_Credito", SqlDbType.Decimal, 9, "Margen_Utilidad_Credito")
			cmdInsert.Parameters.Add("@Margen_Utilidad_Contado", SqlDbType.Decimal, 9, "Margen_Utilidad_Contado")
			cmdInsert.Parameters.Add("@Cantidad_Minima", SqlDbType.Decimal, 9, "Cantidad_Minima")
			...
			cmdUpdate.Parameters.Add("@Margen_Utilidad_Credito", SqlDbType.Decimal, 9, "Margen_Utilidad_Credito")
			cmdUpdate.Parameters.Add("@Margen_Utilidad_Contado", SqlDbType.Decimal, 9, "Margen_Utilidad_Contado")
			cmdUpdate.Parameters.Add("@Cantidad_Minima", SqlDbType.Decimal, 9, "Cantidad_Minima")
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(8) = New SqlParameter("@Margen_Utilidad_Credito", SqlDbType.Decimal)		
		If IsDBNull(m_Margen_Utilidad_Credito) Then
            arParams(8).Value = DBNull.Value
        Else
            arParams(8).Value = m_Margen_Utilidad_Credito
        End If
		arParams(9) = New SqlParameter("@Margen_Utilidad_Contado", SqlDbType.Decimal)		
		If IsDBNull(m_Margen_Utilidad_Contado) Then
            arParams(9).Value = DBNull.Value
        Else
            arParams(9).Value = m_Margen_Utilidad_Contado
        End If
		arParams(10) = New SqlParameter("@Cantidad_Minima", SqlDbType.Decimal)		
