...
#Region " Variables Miembro " 
	...
	Protected m_ObjBodegaOrigenID As Integer 
...
#Region " Propiedades "
	...
	Public Property ObjBodegaOrigenID() As Integer
        Get
            Return (m_ObjBodegaOrigenID)
        End Get
		Set(ByVal Value As Integer)					
			m_ObjBodegaOrigenID = Value
		End Set
    End Property
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdDelete.CommandText = "DELETE FROM  SivTransferencia WHERE SivTransferenciaID= @SivTransferenciaID" 	

			'CREACION DEL COMANDO INSERT
			cmdInsert.Parameters.Add("@ObjBodegaDestinoID", SqlDbType.Int, 4, "ObjBodegaDestinoID")
			cmdInsert.Parameters.Add("@ObjBodegaOrigenID", SqlDbType.Int, 4, "ObjBodegaOrigenID")
			...
			cmdInsert.CommandText = "INSERT INTO SivTransferencia ( ObjBodegaDestinoID, ObjBodegaOrigenID, Observaciones, Fechasolicitud, SolicitadoPor, Fechadespacho, DespachadoPor, Fecharecibido, RecibidoPor, costototal, ObjEstadoID, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion) VALUES ( @ObjBodegaDestinoID, @ObjBodegaOrigenID, @Observaciones, @Fechasolicitud, @SolicitadoPor, @Fechadespacho, @DespachadoPor, @Fecharecibido, @RecibidoPor, @costototal, @ObjEstadoID, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion)"

			'CREACION DEL COMANDO UPDATE
			cmdUpdate.Parameters.Add("@ObjBodegaDestinoID", SqlDbType.Int, 4, "ObjBodegaDestinoID")
			cmdUpdate.Parameters.Add("@ObjBodegaOrigenID", SqlDbType.Int, 4, "ObjBodegaOrigenID")
			...
			cmdUpdate.CommandText = "UPDATE SivTransferencia SET ObjBodegaDestinoID=@ObjBodegaDestinoID, ObjBodegaOrigenID=@ObjBodegaOrigenID, Observaciones=@Observaciones, Fechasolicitud=@Fechasolicitud, SolicitadoPor=@SolicitadoPor, Fechadespacho=@Fechadespacho, DespachadoPor=@DespachadoPor, Fecharecibido=@Fecharecibido, RecibidoPor=@RecibidoPor, costototal=@costototal, ObjEstadoID=@ObjEstadoID, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion WHERE SivTransferenciaID= @wSivTransferenciaID"
...
#Region " Retrieve "
    ...
    Public Function Retrieve(Byval p_SivTransferenciaID as Integer, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        Dim sSQL As String = "select * from SivTransferencia where " & " SivTransferenciaID = " & p_SivTransferenciaID		
        ...
        Try
			...
			If dr.Read() Then		
				...
				m_ObjBodegaOrigenID = IIf(IsDBNull(dr("ObjBodegaOrigenID")), Nothing, dr("ObjBodegaOrigenID"))					
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
		...
		sCommand &= "SivTransferenciaID = SCOPE_IDENTITY()"
		
		
		Dim arParams(15) As SqlParameter
		arParams(0) = New SqlParameter("@SivTransferenciaID", SqlDbType.Int)		
		arParams(0).Direction = ParameterDirection.Output
		arParams(1) = New SqlParameter("@ObjBodegaDestinoID", SqlDbType.Int)		
		If IsDBNull(m_ObjBodegaDestinoID) Then
            arParams(1).Value = DBNull.Value
        Else
            arParams(1).Value = m_ObjBodegaDestinoID
        End If
		arParams(2) = New SqlParameter("@ObjBodegaOrigenID", SqlDbType.Int)		
		If IsDBNull(m_ObjBodegaOrigenID) Then
            arParams(2).Value = DBNull.Value
        Else
            arParams(2).Value = m_ObjBodegaOrigenID
        End If
...
#Region " Update "
	...
	Public Sub Update(Optional ByRef pTransac As TransactionManager = Nothing)        		
		...
		sCommand &= "ObjBodegaOrigenID = @ObjBodegaOrigenID,"
		...
		sCommand &= " where "	
		sCommand &= "SivTransferenciaID = @SivTransferenciaID"					
...
#Region " Delete "
    ...
    Public Sub Delete(optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SivTransferencia where " & " SivTransferenciaID = " & m_SivTransferenciaID
			If pTransac Is Nothing Then
    ...
    ''' Borra un objeto SivTransferencia de la base de datos
    ''' </summary>    
    Public Shared Sub Delete(Byval p_SivTransferenciaID as Integer, optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SivTransferencia where " & " SivTransferenciaID = " & p_SivTransferenciaID
			If pTransac Is Nothing Then
				SqlHelper.ExecuteNonQuery(CommandType.Text, sSQL)
			Else
				SqlHelper.ExecuteNonQuery(pTransac.Transaction, CommandType.Text, sSQL)
