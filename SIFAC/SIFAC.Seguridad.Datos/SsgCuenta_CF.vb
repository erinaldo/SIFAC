...
#Region " Propiedades "
		...
		Set(ByVal Value As String)		
			If Not Value Is Nothing Then
				If Value.Length > 20 Then
					Throw New ArgumentOutOfRangeException("Login", Value.ToString(), "Valor inv?lido para SsgCuenta.Login. La longitud del valor (" & Value.Length & ") excede la longitud m?xima de la propiedad (20).")
				End If
			End If
			m_Login = Value
		End Set
		...
		Set(ByVal Value As String)		
			If Not Value Is Nothing Then
                If Value.Length > 50 Then
                    Throw New ArgumentOutOfRangeException("Clave", Value.ToString(), "Valor inv?lido para SsgCuenta.Clave. La longitud del valor (" & Value.Length & ") excede la longitud m?xima de la propiedad (50).")
                End If
			End If
			m_Clave = Value
		End Set
	...
	''' <summary>
	''' Indica si la cuenta de usuario est? Activa o no. No permite null.
	''' </summary>
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.Parameters.Add("@Login", SqlDbType.VarChar, 20, "Login")
			cmdInsert.Parameters.Add("@Clave", SqlDbType.VarChar, 20, "Clave")
			...
			cmdInsert.CommandText = "INSERT INTO SsgCuenta ( Login, Clave, Activo, FechaExpiracion, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion, objEmpleadoID) VALUES ( @Login, @Clave, @Activo, @FechaExpiracion, @UsuarioCreacion, @FechaCreacion, @UsuarioModificacion, @FechaModificacion, @objEmpleadoID)"

			'CREACION DEL COMANDO UPDATE
			cmdUpdate.Parameters.Add("@Login", SqlDbType.VarChar, 20, "Login")
			cmdUpdate.Parameters.Add("@Clave", SqlDbType.VarChar, 20, "Clave")
			...
			cmdUpdate.CommandText = "UPDATE SsgCuenta SET Login=@Login, Clave=@Clave, Activo=@Activo, FechaExpiracion=@FechaExpiracion, UsuarioCreacion=@UsuarioCreacion, FechaCreacion=@FechaCreacion, UsuarioModificacion=@UsuarioModificacion, FechaModificacion=@FechaModificacion, objEmpleadoID=@objEmpleadoID WHERE SsgCuentaID= @wSsgCuentaID"
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(9) = New SqlParameter("@objEmpleadoID", SqlDbType.Int)		
		If IsDBNull(m_objEmpleadoID) Then
            arParams(9).Value = DBNull.Value
        Else
            arParams(9).Value = m_objEmpleadoID
        End If
