...
'-- Fecha: 09 Junio 2010, 03:15 pm.
'-- Reporte de despacho de transferencia y detalle de repuestos despachados agrupados por SitoOrigen - SitioDestino

Imports DataDynamics.ActiveReports
Imports DataDynamics.ActiveReports.Document
Imports Proyecto.Configuracion 'uso de clsProyecto, clsError

Public Class rptTransferenciaDespachos 
    Private objEncabezado As rptEncabezadoReportesSIFUM

#Region "Iniciar Reporte"
    Private Sub rptTransferenciaDespachos_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        Me.CargarEncabezado()
