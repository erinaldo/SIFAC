...
Partial Public Class rptEncabezadoReportes
    ...
    Private Sub InitializeComponent()
        ...
        Me.ReportHeader1.Height = 0.65625!
        ...
        Me.lblNombreEmpresa.Height = 0.1875!
        Me.lblNombreEmpresa.HyperLink = Nothing
        Me.lblNombreEmpresa.Left = 0.125!
        Me.lblNombreEmpresa.Name = "lblNombreEmpresa"
        Me.lblNombreEmpresa.Style = "ddo-char-set: 0; text-align: center; font-weight: bold; font-size: 9.75pt; "
        Me.lblNombreEmpresa.Text = ""
        Me.lblNombreEmpresa.Top = 0.125!
        Me.lblNombreEmpresa.Width = 7.375!
        '
        'lblSiglas
        '
        ...
        Me.lblSiglas.Left = 0.125!
        Me.lblSiglas.Name = "lblSiglas"
        Me.lblSiglas.Style = "ddo-char-set: 0; text-align: center; font-weight: bold; font-size: 9.75pt; "
        Me.lblSiglas.Text = "SISTEMA DE CARTERA Y COBRO UNITED MOTORS - SCCUM"
        Me.lblSiglas.Top = 0.375!
        Me.lblSiglas.Width = 7.375!
        '
        'ReportFooter1
        '
