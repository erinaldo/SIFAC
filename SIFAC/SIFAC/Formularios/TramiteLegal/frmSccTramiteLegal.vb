...
#Region "Cargar datos"
    ''' <summary>
    ''' Procedimiento encargado de cargar los datos correspondientes de los trámites legales.
    ''' Autor : Gelmin Martínez.
...
#Region " Nuevo Tramite"
    ...
    ''' <summary>
    ''' Procedimiento encargado de crear un nuevo trámite
...
#Region "Anular Trámite"
    Private Sub cmdAnularTramite_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAnularTramite.Click
        If MsgBox("¿Seguro que desea anular el trámite?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, clsProyecto.SiglasSistema) = MsgBoxResult.Yes Then
            Me.IDTramite = Me.grdTramitesLegales.Columns("SccTramiteLegalID").Value
            If Me.AnularTramite() Then
                MsgBox("Trámite Anulado correctamente.", MsgBoxStyle.Information, clsProyecto.SiglasSistema)
                Me.CargaDatos()
            End If
        End If
    End Sub
    ...
    Public Sub ImprimirTramiteLegal(ByVal sCuentaId As String, ByVal sTiendaId As String, ByVal sAbogado As String, ByVal sComentarios As String)
        ...
        Try
            Try
                ...
                objReportes.Text = "Estado de cuenta a Trámite Legal"
                objReportes.Show()
