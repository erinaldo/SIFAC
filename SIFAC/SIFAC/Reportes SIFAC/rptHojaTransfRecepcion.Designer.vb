...
Partial Public Class rptHojaTransfRecepcion
    ...
    Private Sub InitializeComponent()
        ...
        'XrLabel26
        '
        Me.XrLabel26.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "CustomSqlQuery.Fecharecibido")})
