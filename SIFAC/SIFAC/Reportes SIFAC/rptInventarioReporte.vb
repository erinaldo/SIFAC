...
Public Class rptInventarioReporte
...
#Region "Iniciar Reporte"
    Private Sub rptInventarioReporte_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        Me.CargarEncabezado()
...
#Region "Configurar columnas de costo, precio y totales"
    ...
    Private Sub MostrarTotales(ByVal blnMostrar As Boolean)
        'No mostrar todad la banda de pie de grupo bodegas
        Me.Pie_GrupoBodegas.Visible = blnMostrar
        Me.txtTotalPrecioBodegas.Visible = Me.VerPrecioU
        Me.txtTotalCostoBodegas.Visible = Me.VerCostoU
        'Retar altura a PieGrupoTipoRepuesto para solo mostrar la línea inferior de detalle
        Me.Pie_GrupoTipoRepuesto.Height = 0.1
        Me.lblTotalTipoRepuesto.Visible = blnMostrar
        Me.txtTotalCostoTipoRep.Visible = Me.VerCostoU
        Me.txtTotalPrecioTipoRep.Visible = Me.VerPrecioU
        ...
        'Enmarcar totales
        If blnMostrar Then
            clsReportes.Enmarcar(Me.txtTotalCostoTipoRep, Color.Silver)
            clsReportes.Enmarcar(Me.txtTotalCostoBodegas, Color.Silver)
            clsReportes.Enmarcar(Me.txtGranTotalCosto, Color.Silver)
            clsReportes.Enmarcar(Me.txtTotalPrecioTipoRep, Color.Silver)
...
#Region "Crear Etiquetas de encabezado de detalle"
    Private Sub CrearEtiquetasEncabezadoDetalle()
        ...
        If (Not Me.VerTotales) Then
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Descripción", objFuente, objPunto, ANCHO_DESC + DESPLAZAMIENTO + 0.3, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Marca", objFuente, objPunto, ANCHO_MARCA + DESPLAZAMIENTO, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Ubicación", objFuente, objPunto, ANCHO_UBICACION + DESPLAZAMIENTO, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Existencia", objFuente, objPunto, ANCHO_EXISTENCIA + DESPLAZAMIENTO, Alto)
        Else
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Descripción", objFuente, objPunto, ANCHO_DESC, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Marca", objFuente, objPunto, ANCHO_MARCA, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Ubicación", objFuente, objPunto, ANCHO_UBICACION, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Existencia", objFuente, objPunto, ANCHO_EXISTENCIA, Alto)
        End If

        If Me.VerCostoU Then
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Costo U", objFuente, objPunto, ANCHO_COSTOU, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Total Costo", objFuente, objPunto, ANCHO_TOTALCOSTO, Alto)
        End If
        If Me.VerPrecioU Then
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Precio U", objFuente, objPunto, ANCHO_PRECIOU, Alto)
            Me.CrearEtiquetas(Me.Encabezado_GrupoTipoRepuesto, "Total Precio", objFuente, objPunto, ANCHO_TOTALPRECIOU, Alto)
        End If
    End Sub
...
#Region "Desplazar controles horizontalmente"
    Private Sub DesplazarControlesHorizontalmente(ByVal sglValor As Single)
        ...
        For Each etiqueta As ARControl In Me.Encabezado_GrupoTipoRepuesto.Controls
                    ...
                    Select Case (UCase(.Text))
                        ...
                        Case "COSTOU", "TOTALCOSTO", "PRECIOU", "TOTALPRECIO"
                            ...
                            If UCase(.Text) = "TOTALCOSTO" Then
                                Me.txtTotalCostoTipoRep.Location = New PointF(objPunto.X - (Me.txtTotalCostoTipoRep.Width - ANCHO_COSTOU), objPunto.Y)
                            ...
                            If UCase(.Text) = "TOTALPRECIO" Then
                                Me.txtTotalPrecioTipoRep.Location = New PointF(objPunto.X - (Me.txtTotalPrecioTipoRep.Width - ANCHO_PRECIOU), objPunto.Y)
